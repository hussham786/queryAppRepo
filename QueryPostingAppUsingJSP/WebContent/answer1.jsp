...
<%try {
				try {
					FileOutputStream outputStream = new FileOutputStream("test.js");
					...
					for (int j = 1; j < 3; j++) {
						...
						bufferedWriter.write("  var quill" + j + " = new Quill('#editor'" + j
								+ ", {  modules: { toolbar:toolbarOptions  }, theme: 'snow'}); ");
						bufferedWriter.newLine();
						bufferedWriter.write("  $('#answerBtn'" + j + ").click(function(){ " + " $('#text_editor_window_'" + j
								+ ").toggle(); }); ");
			...
			<div class="col-sm-6 question_wrapper_div rounded">
				...
				<div class="container">
					<div class="card-header rounded" id="queHeaderHelp">
						<i class="fas fa-question-circle"> Requested  </i>
					</div>
				</div>
											...
											<div class="reason_main">
												...
												<div class="question_wrapper_div"
													...
													<a href="#"> <span class="ui_content_question">
															...
															id="ui_question_text"> <%=rs2.getString("questionDesc")%>
															<%
																
															session.setAttribute("question", rs2.getString("questionDesc"));
															
															/* int questionId = rs2.getInt("questionId");
															int postedById = rs2.getInt("postedBy");
															 */
															/* int answeredBy =(int) session.getAttribute("user_id"); */
															/* int answeredBy = 130; */
															
															java.sql.Date date = rs2.getDate("dateQuestioned");
												...
												<div class="question_footer_content_wrapper"
													...
													<div class="quetion_footer_text_answer_and_time">
														<a href="#" class="link_for_answer_count"
															id="link_for_que_footer_answer1">1 Answer</a> <span
														...
														<div class=" answer_button_inner " id="">
															<div class="answer_button_icon_wrapper">
																<div class="answer_btn_div_inner" id="answerBtn<%=i%>">
																	<a href="#" class="link_for_answer_button" onclick="openEditor(<%=i%>)"> <span
